...
export default function Home() {
  ...
  return (
      ...
      <div className="mt-auto flex flex-col items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
        <a
        ...
        >
          code by <code className="font-mono font-bold">@gracesanford </code>
        </a>
